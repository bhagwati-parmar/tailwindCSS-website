...
const Watches = () => {
  ...
  const watchData = [
    ...
    { id: 4, name: 'Rolex', price: 152000, description: 'sport watch', image: '/w4.jpeg' },
    { id: 5, name: 'Ruby', price: 18500, description: 'master piece watch', image: '/w7.jpeg' },
      ...
      <div className="watches grid grid-cols-1 md:grid-cols-3 gap-10 px-10 my-10">
        {watchData.map((watch)  => (
          <div key={watch.id} className="watch-card bg-white p-5 rounded-md shadow-md text-center">
             <Image src={watch.image} alt={watch.name} className='w-full rounded-md transition-transform duration-300 transform hover:scale-110' />
